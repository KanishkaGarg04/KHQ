...
const LOGS = [
  ...
  },
  {
    ts: "2026-05",
    tag: "SHIP",
    title: "Built & Deployed health-intelligence-report-insights-platform",
    body: "Built health-intelligence-report-insights-platform, an AI-powered medical report analysis platform using OCR and AI to extract information from medical reports and generate useful insights. Took the project from development to deployment.",
    color: "var(--neon-violet)",
  },
  {
    ts: "2026-05",
